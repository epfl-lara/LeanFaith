"""LF-014 live: build repr_v2 views via #check against the fixture library."""
...
def test_build_repr_v2_views_from_fixture_library(backend: LeanInteractBackend) -> None:
    theorems = [
    ...
    for theorem in theorems:
        ...
        assert record.normalization_version == "repr_v2"
