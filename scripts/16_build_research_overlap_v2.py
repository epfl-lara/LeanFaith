#!/usr/bin/env python3
"""Materialize scalable overlap records for the exact LF-021 40-problem pool."""
...
_POOL_RECORDS = Path(
    "data/parsed/real_outputs/gate3_docstrings_operational_v1/problem_pool_records.jsonl"
)
_POOL_MANIFEST = Path(
    "data/parsed/real_outputs/gate3_docstrings_operational_v1/problem_pool_manifest.json"
)
_OUTPUT = Path("reports/generation/overlap_v2/gate3_docstrings_operational_v1")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Build or exactly replay three overlap-v2 records. "
    ...
    try:
        materialized = materialize_research_overlap_v2(
